...
plan = [[pi/6,pi/6,pi/6,pi/6,pi/6,pi/6],[pi/3,pi/3,pi/3,pi/3,pi/3,pi/3],[pi/2,pi/2,pi/2,pi/2,pi/2,pi/2],[2*pi/3,2*pi/3,2*pi/3,2*pi/3,2*pi/3,2*pi/3],[pi,pi,pi,pi,pi,pi],[0,0,0,0,0,0]]
def main():
